defmodule Router.Server.Worker do
  @moduledoc """
  TODO
  """
  ...
  def handle_call({:process, message}, _from, state) do
    Logger.debug "Process with pid #{inspect self} is processing a router message."
    Router.Server.Handler.handle_message(message)
    {:reply, :ok, state}
  end
end
